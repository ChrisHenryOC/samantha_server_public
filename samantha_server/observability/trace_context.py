...
attribute set defined in the union table, replacing the three
...
class TraceContext:
    ...
    Invariant: session_id and scenario_id are mutually
    ...
    # Synthetic LIS order identifier; independent of the session_id/
