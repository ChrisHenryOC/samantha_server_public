...
class TestRuleIndex:
    ...
    def test_accessioning_sorted_by_severity_hierarchy(self) -> None:
        specs = [
            _make_spec("ACC-A", "ACCESSIONING", severity="ACCEPT"),
            _make_spec("ACC-P", "ACCESSIONING", severity="PROCEED"),
            _make_spec("ACC-H", "ACCESSIONING", severity="HOLD"),
            _make_spec("ACC-R", "ACCESSIONING", severity="REJECT"),
        ]
        index = RuleIndex(specs)
